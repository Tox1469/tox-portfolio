...
const COMMANDS: Record<Lang, Record<string, string[]>> = {
  en: {
    ...
    whoami: [
      "Tox.dev — Full-Stack Development & Security",
      "",
      "The name comes from the Tox encrypted protocol.",
      "We audited the security of uTox — P2P, E2E, zero-trust.",
      "",
      "7+ years building production systems from scratch.",
      "Architecture, database, API, frontend, deploy.",
      "",
      "We build SaaS platforms, AI agents, real-time apps,",
      "and provide security consulting for banks and enterprises.",
      "",
      "Every project here — designed, developed,",
      "and deployed by Tox.dev.",
    ],
    skills: [
      "// Languages",
    ...
    security: [
      ...
      "",
      "Technical security consulting for",
  ...
  pt: {
    ...
    whoami: [
      "Tox.dev — Desenvolvimento Full-Stack & Segurança",
      "",
      "O nome vem do protocolo Tox de criptografia.",
      "Fizemos a auditoria de segurança do uTox — P2P, E2E, zero-trust.",
      "",
      "7+ anos construindo sistemas em produção do zero.",
      "Arquitetura, banco de dados, API, frontend, deploy.",
      "",
      "Construímos plataformas SaaS, agentes de IA, apps real-time,",
      "e prestamos consultoria de segurança para bancos e empresas.",
      "",
      "Cada projeto aqui — projetado, desenvolvido",
      "e entregue pela Tox.dev.",
    ],
    skills: [
      "// Linguagens",
      "TypeScript, JavaScript, Python, SQL, Lua",
    ...
    security: [
      ...
      "",
      "Consultoria técnica de segurança para",
